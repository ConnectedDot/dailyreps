...
function EditEntry() {
	...
	const entry = useQuery(api.functions.logged_reps.getEntry, {
		entryId: local.entryId as string,
	});

	const updateMutation = useMutation(api.functions.logged_reps.update);
	const removeMutation = useMutation(api.functions.logged_reps.remove);
